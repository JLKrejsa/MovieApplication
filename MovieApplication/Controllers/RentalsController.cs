...
namespace MovieApplication.Controllers
{
    public class RentalsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RentalId,CustomerID,MovieID,DateTime")] Rental rental)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RentalId,CustomerID,MovieID,DateTime")] Rental rental)
        {
            if (ModelState.IsValid)
            {
